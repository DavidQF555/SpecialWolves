...
public class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        wolfMenu.addItem(normal);
        wolfMenu.addItem(poison);
        wolfMenu.addItem(fire);
        wolfMenu.addItem(wither);
        wolfMenu.addItem(ice);
        wolfMenu.addItem(troll);
        wolfMenu.addItem(snowball);
        wolfMenu.addItem(shulker);
        wolfMenu.addItem(fireball);
        wolfMenu.addItem(egg);
        wolfMenu.addItem(arrow);
        wolfMenu.addItem(teleport);
        wolfMenu.addItem(dragon);
        ...
        if (!e.getEntityType().equals(EntityType.EXPERIENCE_ORB)) {
            ...
            if (entity.hasMetadata("wolfType")) {
                for (final MetadataValue metadata : entity.getMetadata("wolfType")) {
                    (new BukkitRunnable() {
                        public void run() {
                            if (!entity.isDead() && !target.isDead() && entity.getLocation().distance(target.getLocation()) <= 20 && entity instanceof Wolf && !((Wolf) entity).isSitting()) {
                                if (entity.hasLineOfSight(target)) {
                                    if (metadata.asString().equals("wither")) {
                                        WitherSkull witherSkull = entity.getWorld().spawn(entity.getLocation(), WitherSkull.class);
                                        witherSkull.setShooter(entity);
                                        witherSkull.setGravity(false);
                                        witherSkull.setVelocity(entity.getLocation().getDirection().multiply(1.5));
                                    } else if (metadata.asString().equals("snowball")) {
                                        Snowball snowball = entity.getWorld().spawn(entity.getLocation(), Snowball.class);
                                        ...
                                        ShulkerBullet shulkerBullet = entity.getWorld().spawn(entity.getLocation(), ShulkerBullet.class);
                                        shulkerBullet.setShooter(entity);
                                        shulkerBullet.setTarget(target);
                                        shulkerBullet.setVelocity(entity.getLocation().getDirection().multiply(1.5));
                                        ...
                                        fireball.setVelocity(entity.getLocation().getDirection().multiply(1.5));
                                    } else if (metadata.asString().equals("egg")) {
                                        Egg egg = entity.getWorld().spawn(entity.getLocation(), Egg.class);
                                        egg.setShooter(entity);
                                        egg.setGravity(true);
                                        egg.setVelocity(entity.getLocation().getDirection().multiply(1.5));
                                        ...
                                        if (entity.getLocation().distance(target.getLocation()) > 10) {
                                            entity.teleport(target);
                                        }
                                    } else if (metadata.asString().equals("dragon")) {
                                        ((Vex) entity.getVehicle()).setTarget(target);
                                        DragonFireball dragonFireball = entity.getWorld().spawn(entity.getLocation(), DragonFireball.class);
                            ...
                            } else if (!entity.isDead() && !target.isDead() && entity.getLocation().distance(target.getLocation()) <= 20 && entity instanceof Vex) {
